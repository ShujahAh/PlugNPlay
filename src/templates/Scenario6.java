...
public class Scenario6 implements Template {
	...
	ImageIcon image_edit = new ImageIcon(new ImageIcon("src/images/Scenario6.png").getImage().getScaledInstance(screenSize.width/3-10,screenSize.width/7, Image.SCALE_DEFAULT));
	ImageIcon image_act = new ImageIcon(new ImageIcon("src/images/Scenario6.png").getImage().getScaledInstance(screenSize.width*3/4-20, (int) (screenSize.height/1.9), Image.SCALE_DEFAULT));
	ImageIcon image_button = new ImageIcon(new ImageIcon("src/images/Scenario6.png").getImage().getScaledInstance(200,200, Image.SCALE_DEFAULT));
	...
	public Scenario6(List<String> data){
	...
	public String getText() {
		String nametemplate_data = "Scenario6";
	...
	public void setSizetoPlay(boolean yes) {
		...
		if (yes) {
			...
			text1_os.setBounds((int) (screenSize.width/15),screenSize.height/25,  (int) (screenSize.width/3.65), screenSize.height/8);
			text1_os.setFont(new Font(text3_os.getFont().getFontName(), Font.BOLD, 20));
			text2_os.setBounds((int) (screenSize.width/2.6),screenSize.height/25, (int) (screenSize.width/3.65), screenSize.height/8);
			text2_os.setFont(new Font(text3_os.getFont().getFontName(), Font.BOLD, 20));
			text3_os.setBounds((int) (screenSize.width/3.3),(int) (screenSize.height/2.6), (int) (screenSize.width/6.5), screenSize.height/6);
			...
			text1_os.setBounds((int) (screenSize.width/35),screenSize.height/45,  screenSize.width/8, screenSize.height/17);
			text2_os.setBounds((int) (screenSize.width/6),screenSize.height/45, (int) (screenSize.width/8), screenSize.height/17);
			text3_os.setBounds((int) (screenSize.width/7.5),(int) (screenSize.height/5.3), screenSize.width/14, screenSize.height/17);
			button1_os.setPreferredSize(buttons);
			button2_os.setPreferredSize(buttons);
			button3_os.setPreferredSize(buttons);
			button4_os.setPreferredSize(buttons);
