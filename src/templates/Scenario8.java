...
public class Scenario8 implements Template {
	...
	ImageIcon image_edit = new ImageIcon(new ImageIcon("src/images/Scenario8.png").getImage().getScaledInstance(screenSize.width/3-10,screenSize.width/7, Image.SCALE_DEFAULT));
	ImageIcon image_act = new ImageIcon(new ImageIcon("src/images/Scenario8.png").getImage().getScaledInstance(screenSize.width*3/4-20, (int) (screenSize.height/1.9), Image.SCALE_DEFAULT));
	ImageIcon image_button = new ImageIcon(new ImageIcon("src/images/Scenario8.png").getImage().getScaledInstance(200,200, Image.SCALE_DEFAULT));
	JLabel background;
	
	
	
	public Scenario8(List<String> data){
	...
	public String getText() {
		String nametemplate_data = "Scenario8";
	...
	public void setSizetoPlay(boolean yes) {
		...
		if (yes) {
			...
			text1_os.setBounds((int) (screenSize.width/45),screenSize.height/10,  (int) (screenSize.width/5), screenSize.height/8);
			text1_os.setFont(new Font(text3_os.getFont().getFontName(), Font.BOLD, 20));
			text2_os.setBounds((int) (screenSize.width/2.17),(int) (screenSize.height/8.7), (int) (screenSize.width/4.1), screenSize.height/7);
			...
			text1_os.setBounds((int) (screenSize.width/80),screenSize.height/20,  screenSize.width/11, screenSize.height/15);
			text2_os.setBounds((int) (screenSize.width/4.9),(int) (screenSize.height/17), (int) (screenSize.width/8.9), screenSize.height/16);
