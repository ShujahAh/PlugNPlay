...
public class Scenario7 implements Template {
	...
	ImageIcon image_edit = new ImageIcon(new ImageIcon("src/images/Scenario7.png").getImage().getScaledInstance(screenSize.width/3-10,screenSize.width/7, Image.SCALE_DEFAULT));
	ImageIcon image_act = new ImageIcon(new ImageIcon("src/images/Scenario7.png").getImage().getScaledInstance(screenSize.width*3/4-20, (int) (screenSize.height/1.9), Image.SCALE_DEFAULT));
	ImageIcon image_button = new ImageIcon(new ImageIcon("src/images/Scenario7.png").getImage().getScaledInstance(200,200, Image.SCALE_DEFAULT));
	JLabel background;
	
	
	
	public Scenario7(List<String> data){
	...
	public String getText() {
		String nametemplate_data = "Scenario7";
	...
	public void setSizetoPlay(boolean yes) {
		...
		if (yes) {
			...
			text1_os.setBounds((int) (screenSize.width/45),screenSize.height/45,  (int) (screenSize.width/4), screenSize.height/8);
			text1_os.setFont(new Font(text3_os.getFont().getFontName(), Font.BOLD, 20));
			text2_os.setBounds((int) (screenSize.width/2.15),(int) (screenSize.height/3.6), (int) (screenSize.width/4.1), screenSize.height/6);
			text2_os.setFont(new Font(text3_os.getFont().getFontName(), Font.BOLD, 20));
			text3_os.setBounds((int) (screenSize.width/13),(int) (screenSize.height/2.4), (int) (screenSize.width/4), screenSize.height/10);
			...
			text1_os.setBounds((int) (screenSize.width/60),screenSize.height/60,  screenSize.width/10, screenSize.height/17);
			text2_os.setBounds((int) (screenSize.width/4.8),(int) (screenSize.height/7.5), (int) (screenSize.width/9.5), screenSize.height/12);
			text3_os.setBounds((int) (screenSize.width/50),(int) (screenSize.height/5.3), screenSize.width/7, screenSize.height/20);
			button1_os.setPreferredSize(buttons);
			button2_os.setPreferredSize(buttons);
			button3_os.setPreferredSize(buttons);
			button4_os.setPreferredSize(buttons);
