...
public class Scenario9 implements Template {
	...
	ImageIcon image_edit = new ImageIcon(new ImageIcon("src/images/Scenario9.png").getImage().getScaledInstance(screenSize.width/3-10,screenSize.width/7, Image.SCALE_DEFAULT));
	ImageIcon image_act = new ImageIcon(new ImageIcon("src/images/Scenario9.png").getImage().getScaledInstance(screenSize.width*3/4-20, (int) (screenSize.height/1.9), Image.SCALE_DEFAULT));
	ImageIcon image_button = new ImageIcon(new ImageIcon("src/images/Scenario9.png").getImage().getScaledInstance(200,200, Image.SCALE_DEFAULT));
	JLabel background;
	
	
	
	public Scenario9(List<String> data){
	...
	public String getText() {
		String nametemplate_data = "Scenario9";
	...
	public void setSizetoPlay(boolean yes) {
		...
		if (yes) {
			...
			text1_os.setBounds((int) (screenSize.width/3.6),screenSize.height/14,  (int) (screenSize.width/6.5), screenSize.height/15);
			text1_os.setFont(new Font(text3_os.getFont().getFontName(), Font.BOLD, 20));
			text2_os.setBounds((int) (screenSize.width/3.6),(int) (screenSize.height/4.8), (int) (screenSize.width/6.5), screenSize.height/15);
			text2_os.setFont(new Font(text3_os.getFont().getFontName(), Font.BOLD, 20));
			text3_os.setBounds((int) (screenSize.width/13),(int) (screenSize.height/4), (int) (screenSize.width/7), screenSize.height/14);
			...
			text1_os.setBounds((int) (screenSize.width/7.7),screenSize.height/35,  screenSize.width/17, screenSize.height/25);
			text2_os.setBounds((int) (screenSize.width/7.7),(int) (screenSize.height/11),  screenSize.width/16, screenSize.height/25);
			text3_os.setBounds((int) (screenSize.width/50),(int) (screenSize.height/9), screenSize.width/15, screenSize.height/20);
			button1_os.setPreferredSize(buttons);
			button2_os.setPreferredSize(buttons);
			button3_os.setPreferredSize(buttons);
			button4_os.setPreferredSize(buttons);
